...
public class SubjectController {
    ...
    public void persist() throws IOException {
        ...
        if (subjectDao.persist(subject) != null) {
            flash.put("created", "Subject created successfully");
            context.getExternalContext().redirect(context.getExternalContext().getApplicationContextPath() + "/subject/subjects.jsf");
        }
    }
}
