...
public class Parser {
	 ...
	 * 
	 * @param input
	 *            String containing event listing
	...
	public static String parseEvent(String input) {
		...
		String output = "EVENT: " + parseEventType(input) + "; "
	 ...
	 * 
	 * @param input
	 *            String in which to search for event type
	 ...
	 * 
	 * @param input
	 *            String in which to search for participant names
	 ...
	 * 
	 * @param input
	 *            String in which to search for date
	...
	protected static String parseDate(String input) {
		...
		if (matcher.find()) { // does the haystack contain an instance of the
								// needle?
			DateFormat dfIn = new SimpleDateFormat("yyyyMMdd", Locale.US); // input date
																// format
	...
	public static List<String> parseEvents(List<String> input) {
		if (input == null) {
			return null;
		}
		int i = 0;
		for (String content : input) {
			input.set(i++, Parser.parseEvent(content));
		}
		return input;
	}
}